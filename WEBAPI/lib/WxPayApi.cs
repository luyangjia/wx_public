    ...
    public class WxPayApi
    {
        ...
        */
        public static WxPayData UnifiedOrder(WxPayData inputObj, int timeOut = 6)
        {
            ...
            {
                Log.Debug("WxPayApi", "异步通知url未设置，则使用配置文件中的url : " + WxPayConfig.NOTIFY_URL); 
        ...
        */
        ...
        {
            var ran = new Random();
            return string.Format("{0}{1}{2}", WxPayConfig.MCHID, DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(9));
        }
